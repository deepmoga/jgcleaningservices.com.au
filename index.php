...
<main id="main-content">
        ...
        <div class="container">
            ...
            <div class="services-grid services-grid--images">
                ...
                <article class="service-card service-card--image reveal" style="--delay: <?= $index * 70 ?>ms">
                    <a class="service-card__image" href="<?= e(url('services/' . $service['slug'])) ?>"><img src="<?= e(asset((string) ($service['card_image'] ?: 'assets/images/jg-cleaning-team-hero.webp'))) ?>" alt="<?= e($service['title']) ?> service in Melbourne" loading="lazy"><span><?= str_pad((string) ($index + 1), 2, '0', STR_PAD_LEFT) ?></span></a>
                    <div class="service-card__body"><h3><a href="<?= e(url('services/' . $service['slug'])) ?>"><?= e($service['title']) ?></a></h3><p><?= e($service['short_description']) ?></p><a href="<?= e(url('services/' . $service['slug'])) ?>">Explore service <span aria-hidden="true">↗</span></a></div>
                </article>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <section class="section process" id="process" aria-labelledby="process-title"><div class="container"><div class="section-heading section-heading--center reveal"><span class="eyebrow">How it works</span><h2 id="process-title">Four simple steps to a<br>beautifully clean space.</h2></div><div class="process-grid"><article class="process-step reveal"><span>01</span><div class="process-step__icon">✦</div><h3>Tell us what you need</h3><p>Choose a service and share details about the property.</p></article><article class="process-step reveal"><span>02</span><div class="process-step__icon">◷</div><h3>Receive your quote</h3><p>We discuss the scope and provide clear, practical pricing.</p></article><article class="process-step reveal"><span>03</span><div class="process-step__icon">✓</div><h3>We complete the clean</h3><p>Our professional team arrives prepared and gets to work.</p></article><article class="process-step reveal"><span>04</span><div class="process-step__icon">☀</div><h3>Enjoy the result</h3><p>Step back into a fresher, more welcoming space.</p></article></div></div></section>
