...
$canonicalUrl = url();
$currentPage = 'home';
$homeAboutImage = (string) setting('home_about_image', 'assets/images/jg-cleaning-team-hero.webp');
...
<script type="application/ld+json"><?= json_encode(['@context' => 'https://schema.org','@type' => 'CleaningService','name' => setting('site_name'),'url' => url(),'logo' => asset((string) setting('logo_main')),'image' => asset($homeAboutImage),'telephone' => setting('phone_1'),'email' => setting('email_1'),'address' => ['@type' => 'PostalAddress','streetAddress' => setting('address'),'addressLocality' => 'Clayton','addressRegion' => 'VIC','postalCode' => '3169','addressCountry' => 'AU'],'areaServed' => 'Melbourne, Victoria','openingHours' => 'Mo-Sa 08:00-22:00','priceRange' => '$$'], JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) ?></script>
