...
<main id="main-content">
    ...
    <section class="section inner-services"><div class="container"><div class="content-prose content-prose--intro"><?= sanitize_content((string) $page['content']) ?></div><div class="services-grid services-grid--images">
        <?php foreach ($services as $service): ?><article class="service-card service-card--image reveal"><a class="service-card__image" href="<?= e(url('services/' . $service['slug'])) ?>"><img src="<?= e(asset((string) ($service['card_image'] ?: 'assets/images/jg-cleaning-team-hero.webp'))) ?>" alt="<?= e($service['title']) ?> Melbourne" loading="lazy"></a><div class="service-card__body"><h2><a href="<?= e(url('services/' . $service['slug'])) ?>"><?= e($service['title']) ?></a></h2><p><?= e($service['short_description']) ?></p><a href="<?= e(url('services/' . $service['slug'])) ?>">Read service details</a></div></article><?php endforeach; ?>
    </div></div></section>
